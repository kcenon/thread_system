---
doc_id: "THR-ARCH-003b"
doc_title: "Thread System - Architecture Details"
doc_version: "1.0.0"
doc_date: "2026-04-04"
doc_status: "Released"
...
# Thread System - Architecture Details

> **SSOT**: This document is the single source of truth for **Thread System - Architecture Details** (component deep-dives).

> **See also**: [Architecture Overview](ARCHITECTURE_OVERVIEW.md) for high-level system architecture diagrams.
