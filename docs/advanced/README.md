...
| Build on different platforms | [Build Guide](../guides/BUILD_GUIDE.md) |
...
- **[Build Guide](../guides/BUILD_GUIDE.md)** - Platform-specific build instructions  
...
- [Build Guide](../guides/BUILD_GUIDE.md) - Cross-platform build instructions
...
**Having build issues?**
Check the [Build Guide](../guides/BUILD_GUIDE.md) for platform-specific instructions and troubleshooting.
