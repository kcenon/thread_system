...
function(check_common_concepts_support)
  ...
  if(_COMMON_CONCEPTS_FOUND)
    ...
    set(KCENON_HAS_COMMON_CONCEPTS FALSE CACHE BOOL "common_system C++20 concepts available" FORCE)
    set(THREAD_HAS_COMMON_CONCEPTS FALSE CACHE BOOL "common_system C++20 concepts available (legacy)" FORCE)
  endif()
endfunction()
